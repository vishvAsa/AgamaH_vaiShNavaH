...
108\. OBJECTION. But how can it be assumed that the Tantra, which conflicts with scripture, has validity? For if it is valid, it becomes optional beside
89 
...
244 
Or if it be held that "outside the Veda" means "Funqualified to perform Vedic acts," and that Pañcaratra is invalid, like the caityavandana statements," because it is accepted by those who, being unqualified, are outside the Veda, the following distinction must be
99 
